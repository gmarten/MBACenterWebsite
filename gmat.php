    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-2 col-sm-3">
                ...
                <br/><br/>
               <center><a href="https://www.eventbrite.fr/" class=" fa fa-check-circle btn btn"> Tickets</a></center>
                    ...
                    <section id="event-detail">
                        <article class="event-detail">
                            <section id="event-header">
                                <header>
                                    <h2 class="event-date">Wednesday 21st January (19h00-21h)</h2>
                                </header>
                                <hr>
                                <div class="course-count-down" id="course-count-down">
                                    ...
                                    <div class="count-down-wrapper">
                                        <script type="text/javascript">var _date = 'Jan 21, 2015 18:30';</script>
                            ...
                            <section id="course-info">
                                ...
                                <p>
                                   MBA Center offers a 75-minute test comprising 18 verbal (Sentence Correction, Critical
                                   Reasoning and Reading Comprehension questions) and 18 math questions (Problem Solving 
                                   and Data Sufficiency). This test is followed by a 75-minute group correction session with 
                                   Hubert Silly who has designed the test.
                                </p>
                                <p>
                                    The objective of the GMAT kit is threefold:
                                    <ol>
                                	<li>Get familiar with GMAT structure</li>
                                	<li>Learn about the difficulty of the GMAT</li>
                                	<li>Assess your GMAT level</li>
                                
                                </ol>
                                </p>
                                <p>The GMAT toolkit will also give you an opportunity to meet our instructors, determine a 
                                study plan with them as well as choose the courses that we have that are most appropriate to 
                                your objectives. This is also an opportunity to come and meet us at our facilities.                                
                                </p>
