                    ...
                    <section id="event-detail">
                        <article class="event-detail">
                            <section id="event-header">
                                <header>
                                    <h2 class="event-date">Friday 23rd January (18h30-21h)</h2>
                                </header>
                                <hr>
                                <div class="course-count-down" id="course-count-down">
                                    ...
                                    <div class="count-down-wrapper">
                                        <script type="text/javascript">var _date = 'Jan 23, 2015 18:30';</script>
                            ...
                            <section id="course-info">
                                ...
                                <p>
                                   Each week the MBA Center students have to complete a full-length test at home (37 math questions and 41 verbal questions). Our weekly test
                                   (GMAT 800) gives our students the opportunity to apply the GMAT theories learnt in class and to develop their GMAT skills (concentration,
                                    accuracy, speed…). On Friday 23rd January our students will spend 2h30 to correct Test 4 with their GMAT instructor.

                                </p>
                                <p>
                                    The objective of the GMAT kit is threefold:
                                    <ol>
                                	<li>Apply the knowledge and techniques learnt in class</li>
                                	<li>Learn about new strategies</li>
                                	<li>Assess the progress of our students</li>
                                
                                </ol>
                                </p>
                                <p>
                                	GMAT 800 is an ideal opportunity to meet our instructors, fellow students, and fine tune a study plan with with our academic team.
                                </p>
