...
<div id="page-content">
    <div class="container">
        <header><h1>GMAT unlimited</h1></header>
        <div class="row">
            <!-- Course Image -->
                    ...
                    <section id="event-detail">
                        <article class="event-detail">
                            <section id="event-header">
                                <header>
                                    <h2 class="event-date">Saturday 31st January (9h-14h)</h2>
                                </header>
                                <hr>
                                <div class="course-count-down" id="course-count-down">
                                    ...
                                    <div class="count-down-wrapper">
                                        <script type="text/javascript">var _date = 'Jan 31, 2015 9:00';</script>
                            ...
                            <section id="course-info">
                                ...
                                <p>
                                   The Saturday 24th January GMAT class will last 5 hours during which we will cover both the math and verbal sections of the GMAT. 
                                   We will use the The GMAT Companion to develop knowledge, strategies and skills to tackle the GMAT. 

                                </p>
                                <p>
                                   Will be covered:
                                    <ol>
                                	<li>Math lesson : <br/>Mental math, first degree equations, word problems, ratio and rates</li>
                                	<li>Verbal, Sentence Correction lesson :<br/> Verb tense, parallelism, and comparisons</li>
                                	
                                
                                </ol>
                                </p>
                                <p>During the lesson your GMAT instructor will check the students’ performance, progress, and completion of the study plan we have set. 
                                Each student can discuss individually with the instructor who can help him/her meet his/her objectives.
