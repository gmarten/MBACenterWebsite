...
<head>
    ...
    <title>Said Business School</title>
...
<div id="page-content">
    <div class="container">
        <header><h1>Said Business School Information session Brussels</h1></header>
        <div class="row">
            <!-- Course Image -->
                    ...
                    <section id="event-detail">
                        <article class="event-detail">
                            <section id="event-header">
                                <header>
                                    <h2 class="event-date">Thursday 22nd January (19h-21h30)</h2>
                                </header>
                                <hr>
                                <div class="course-count-down" id="course-count-down">
                                    ...
                                    <div class="count-down-wrapper">
                                        <script type="text/javascript">var _date = 'Jan 22, 2015 19:00';</script>
                            ...
                            <section id="course-info">
                                ...
                                <p>
                                   Said Business School is organizing an information session in Brussels on Thursday 22nd  
                                   January at the Hotel Bristol Stéphanie, Avenue Louise 91-93, B-1050. Dana Brown, Director 
                                   of the MBA, will introduce you to the MBA and Executive MBA programs offered by Said 
                                   Business School. This event will provide an opportunity for you to learn more about the 
                                   Oxford MBA and Executive MBA (EMBA) programs.
                                </p>
