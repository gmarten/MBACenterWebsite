...
<div id="page-content">
    <div class="container">
        <header><h1>TOEFL Advanced</h1></header>
        <div class="row">
            <!-- Course Image -->
                    ...
                    <section id="event-detail">
                        <article class="event-detail">
                            <section id="event-header">
                                <header>
                                    <h2 class="event-date">Saturday 31st January (14h30-17h)</h2>
                                </header>
                                <hr>
                                <div class="course-count-down" id="course-count-down">
                                    ...
                                    <div class="count-down-wrapper">
                                        <script type="text/javascript">var _date = 'Jan 31, 2015 14:30';</script>
                            ...
                            <section id="course-info">
                                ...
                                <p>
                                   The Saturday 24th January TOEFL class will last 2,5h during which we will develop knowledge, strategies and skills to tackle the TOEFL iBT.
                                   The manual we will use is The Total Prepkit for the TOEFL.
                                </p>
                                <p>
                                    Will be covered:

                                    <ol>
                                	<li>Listening: Dialogues lesson</li>
                                	<li>Reading Comprehension: workshop</li>
                                	
                                
                                </ol>
                                </p>
                                <p>During the lesson your TOEFL instructor will check the students’ performance, progress, and completion of the study plan we have set. Each
                                student can discuss individually with the instructor who can help him/her meet his/her objectives.
